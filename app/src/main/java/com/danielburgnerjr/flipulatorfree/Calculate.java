...
public class Calculate implements Serializable {
	...
	public void calcBudgetRehabType(String strT) {
        ...
        switch (strT) {
            case "Low" -> this.dBudget = (15 * this.nSquareFootage);
            case "Medium" -> {
            ...
            case "High" -> this.dBudget = (30 * this.nSquareFootage);
            case "Super-High" -> this.dBudget = (40 * this.nSquareFootage);
            default -> this.dBudget = (125 * this.nSquareFootage);
        }
	}
